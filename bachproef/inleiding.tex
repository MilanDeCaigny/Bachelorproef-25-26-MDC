...
\begin{itemize}
    ...
    \item Het evalueren van de effectiviteit van de oplossing aan de hand van gedefinieerde KPI's, met name Mean Time to Detect (MTTD) en Mean Time to Repair (MTTR).
\end{itemize}
...
In Hoofdstuk~\ref{ch:resultaten} worden de resultaten van het praktijkonderzoek gepresenteerd. Hierin komen de opzet van de proof-of-concept, de uitgevoerde testsimulaties en de metingen van MTTD, MTTR en alertkwaliteit aan bod.
